      ...
      <ul class="nav navbar-nav flex-row">
        ...
        <li class="nav-item">
          <a class="navbar-brand" href="index.html"
            ...
            />
            <h3 class="brand-text">Taxi Brousse</h3>
          </a>
        </li>
              ...
              <li class="scrollable-container media-list w-100">
                ...
                ><a href="javascript:void(0)">
                  <div class="media">
                    <div class="media-left align-self-center">
                      <i
                        class="ft-download-cloud icon-bg-circle bg-red bg-darken-1 mr-0"
                      ></i>
                    </div>
                    <div class="media-body">
                ...
                ><a href="javascript:void(0)">
                  <div class="media">
                    <div class="media-left align-self-center">
                      <i
                        class="ft-alert-triangle icon-bg-circle bg-yellow bg-darken-3 mr-0"
                      ></i>
                    </div>
                    <div class="media-body">
                ...
                ><a href="javascript:void(0)">
                  <div class="media">
                    <div class="media-left align-self-center">
                      <i
                        class="ft-check-circle icon-bg-circle bg-cyan mr-0"
                      ></i>
                    </div>
                    <div class="media-body">
            ...
            <a
              ...
              ><span class="mr-1 user-name text-bold-700">
                <c:if test="${not empty sessionScope.connecte}">
                  <p>
                    Vous êtes connecté avec le rôle : ${sessionScope.connecte}
                  </p>
                </c:if> </span
  ...
  <div class="main-menu-content">
    ...
    >
      ...
      <li class="nav-item">
        <a href="#">
          <i class="la la-bus"></i>
          <span class="menu-title" data-i18n="Dashboard">VOYAGE</span>
        </a>
        <ul class="menu-content">
          <li>
            <a class="menu-item" href="/voyages/ajouter">
              <i class="la la-plus-circle"></i>
              <span data-i18n="eCommerce">Saisie</span>
            </a>
          </li>
          <li>
            <a class="menu-item" href="/voyages">
      ...
      <li class="nav-item">
        <a href="#">
          ...
          <span class="menu-title" data-i18n="Dashboard">RESERVATION</span>
        </a>
        <ul class="menu-content">
          <li>
            <a class="menu-item" href="/reservations/ajouter">
              <i class="la la-plus-circle"></i>
              <span data-i18n="eCommerce">Saisie</span>
            </a>
          </li>
          <li>
            <a class="menu-item" href="/reservations">
              <i class="la la-list-ul"></i>
              <span data-i18n="eCommerce">Liste</span>
            </a>
          </li>
      ...
      <li class="nav-item">
        ...
        <ul class="menu-content">
          <li>
            <a class="menu-item" href="/trajets/ajouter">
              <i class="la la-plus-circle"></i>
              <span data-i18n="eCommerce">Saisie</span>
            </a>
          </li>
          <li>
            <a class="menu-item" href="/tarifs">
              <i class="la la-list-ul"></i>
              <span data-i18n="eCommerce">Liste</span>
            </a>
          </li>
