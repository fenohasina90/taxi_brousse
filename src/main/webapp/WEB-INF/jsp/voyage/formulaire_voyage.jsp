                            ...
                            <div class="card-content collpase show">
                                <div class="card-body">
                                    ...
                                    <form class="form form-horizontal form-bordered"
                                          method="post"
                                          action="${pageContext.request.contextPath}/voyages/ajouter">

                                        <div class="form-body">

                                            <!-- Trajet -->
                                            <div class="form-group row">
                                                <label class="col-md-3 label-control">Trajet</label>
                                                <div class="col-md-9">
                                                    <select name="id_trajet" class="form-control" required>
                                                        <option value="">-- Choisir un trajet --</option>
                                                        <c:forEach var="t" items="${liste_trajet}">
                                                            <option value="${t.id}">
                                                                ${t.gareDepart.ville} (${t.gareDepart.nom}) →
                                                                ${t.gareArrivee.ville} (${t.gareArrivee.nom})
                                                                - ${t.distanceKm} km
                                                            </option>
                                                        </c:forEach>
                                                    </select>
